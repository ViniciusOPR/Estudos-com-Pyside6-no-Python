...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushSend.setFont(font1)

        self.gridLayout_2.addWidget(self.pushSend, 1, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelResult.setText(QCoreApplication.translate("MainWindow", u"Teste do QTDesigner", None))
